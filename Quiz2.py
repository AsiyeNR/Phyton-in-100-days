...
# cevap = if "c" in my_dictionary.values():
              print("evet")
...
# cevap = r_list = [3,2,5,8,4,6,9,12]
          pi = 3.14
          daire_cevresi = []
          for r in r_list:
            daire_cevresi.append(2*pi*r)
            print(daire_cevresi)
...
# cevap = from random import randint
